...
3. On first launch, run `doas chown -R connor ~/.local/share` and rebuild container to allow programs to save their state onto the newly created `devct_persist` volume.
